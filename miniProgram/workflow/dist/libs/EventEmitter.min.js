...
!function (e) {
  ...
  function t() {}function n(e, t) {
    ...
    if (!i(t)) throw new TypeError("listener must be a function");var r,
      ...
      s.hasOwnProperty(r) && -1 === n(s[r], t) && s[r].push(o ? t : { listener: t, once: !1 });
    }return this;
    ...
    var n,
        ...
        i,
        s,
        o = this.getListenersAsObject(e);for (s in o) {
      if (o.hasOwnProperty(s)) for (n = o[s].slice(0), i = 0; i < n.length; i++) {
